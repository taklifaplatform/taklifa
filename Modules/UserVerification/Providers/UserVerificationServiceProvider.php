...
namespace Modules\UserVerification\Providers;

use Illuminate\Support\ServiceProvider;
use Modules\UserVerification\Entities\UserVerification;
use Modules\UserVerification\Policies\UserVerificationPolicy;
...
class UserVerificationServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $moduleName = 'UserVerification';

    /**
     * @var string
     */
    protected $moduleNameLower = 'userverification';
