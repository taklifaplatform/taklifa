...
class ServiceCategoryResource extends Resource
{
        ...
        return $table
            ...
            ->headerActions([
                Tables\Actions\Action::make('all')
                    ...
                    ->url(fn() => route('filament.admin.resources.service-categories.index'))
                    ->badge()
                ...
                ...static::getParentCategories()->map(function ($category) {
                    ...
                    return Tables\Actions\Action::make($category->id)
                        ...
                        ->url(fn() => route('filament.admin.resources.service-categories.index', ['parent_id' => $category->id]))
                        ->badge()
    ...
    {
        return ServiceCategory::whereNull('parent_id')->orderBy('order', 'asc')->get();
    }
