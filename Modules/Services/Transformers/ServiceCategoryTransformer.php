...
class ServiceCategoryTransformer extends JsonTransformer
{
    /**
    ...
    public function toArray($request)
    {
        return [
            ...
            'sub_categories' => ServiceCategoryTransformer::collection($this->enabledSubCategories),
        ];
    }

    public function schema(): Schema
    {
        return Schema::object('ServiceCategoryTransformer')
            ->properties(
                ...
                Schema::array('metadata_fields')->items(
                    Schema::object('ServiceCategoryTransformer')
                        ->properties(
