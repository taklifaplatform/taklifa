...
class SchemaFactoryMakeCommand extends GeneratorCommand
{
    ...
    protected function buildModel($output, $model): string|array
    {
        ...
        $properties = collect($columns)
            ->map(static function ($column) use ($model, $connection): string {
                /** @var Column $column */
                ...
                $args = array_map(static function (?string $value) {
                    if ($value === null) {
                        return 'null';
                    }
