...
class NotificationTemplatePolicy
{
    ...
    {
        return $user->can('view_any_notification_template');
    }
    ...
    {
        return $user->can('view_notification_template');
    }
    ...
    {
        return $user->can('create_notification_template');
    }
    ...
    {
        return $user->can('update_notification_template');
    }
    ...
    {
        return $user->can('delete_notification_template');
    }
    ...
    {
        return $user->can('delete_any_notification_template');
    }
    ...
    {
        return $user->can('force_delete_notification_template');
    }
    ...
    {
        return $user->can('force_delete_any_notification_template');
    }
    ...
    {
        return $user->can('restore_notification_template');
    }
    ...
    {
        return $user->can('restore_any_notification_template');
    }
    ...
    {
        return $user->can('replicate_notification_template');
    }
    ...
    {
        return $user->can('reorder_notification_template');
    }
} 