...
class ShipmentInvitationDeclinedNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    {
        return __('Declined your shipment invitation');
    }
    ...
    public function toArray($notifiable)
    {
        ...
        return [
            ...
            'type' => 'ShipmentInvitationDeclinedNotification',
